        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                ...
                case 'validate_required' :
                    $resp[] = "<span class=\"$field_class\">$field</span> field is required";
                    break;
                case 'validate_valid_email':
                    $resp[] = "<span class=\"$field_class\">$field</span> field is required to be a valid email address";
                    break;
                case 'validate_max_len':
                    $resp[] = "<span class=\"$field_class\">$field</span> field needs to be $param or shorter in length";
                    break;
                case 'validate_min_len':
                    $resp[] = "<span class=\"$field_class\">$field</span> field needs to be $param or longer in length";
                    break;
