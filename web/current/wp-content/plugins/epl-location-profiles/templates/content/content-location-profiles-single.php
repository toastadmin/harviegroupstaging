<?php
/**
 * Template for single Location Profiles
 *
...
<div id="post-<?php the_ID(); ?>" <?php post_class( 'epl-location-profiles-single' ); ?>>
	...
	<div class="entry-content clearfix">
		...
		<div class="tab-wrapper">
			...
			<!-- Location Profile Listings  -->
			<?php do_action( 'epl_location_profile_listings' ); ?>
	...
	<div class="entry-footer clearfix">
		<div class="entry-meta">
			<?php wp_link_pages( array( 'before' => '<div class="entry-utility entry-pages">' . __( 'Pages:', 'epl-location-profiles' ) . '', 'after' => '</div>', 'next_or_number' => 'number' ) ); ?>
		</div>
	</div>
</div>
<!-- end .post -->
