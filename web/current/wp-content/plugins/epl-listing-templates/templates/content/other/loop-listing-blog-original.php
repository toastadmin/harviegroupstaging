...
<div id="post-<?php the_ID(); ?>" <?php post_class('epl-listing-post epl-property-blog epl-theme-property-blog-default epl-clearfix'); ?> <?php do_action('epl_archive_listing_atts'); ?>>
