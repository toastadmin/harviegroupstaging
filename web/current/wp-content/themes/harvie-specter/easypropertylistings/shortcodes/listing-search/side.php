...
if ( ! empty( $selected_post_types ) ) :
	...
	?>
	<div class="epl-search-form-side epl-search-forms-wrapper epl-search-<?php echo $style; ?>">
	<?php
		...
		<form method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
			...
			<?php
				...
				foreach ( $epl_frontend_fields as &$epl_frontend_field ) {
					...
					if($epl_frontend_field['key'] == 'search_other'){
						continue;
					}
					...
					if($epl_frontend_field['key'] == 'post_type'){
						$value = $queried_post_type;
						$config = 'on';
					}
				...
				<div class="fm-block epl-search-row-half epl-search-custom-size">
					...
					<input type="submit" value="<?php echo $submit_label != '' ? $submit_label : __('Search', 'easy-property-listings' ); ?>" class="epl-search-btn side-btn" />
					<button class="more-options btn side-btn">More Options <i class="fa fa-chevron-down"></i></button>
				</div>
