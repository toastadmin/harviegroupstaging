...
function epl_property_bed(){
	global $property;
	echo '<span class="epl-property-bed">' . $property->get_property_category() . '</span> ';
}
add_action('epl_property_bed','epl_property_bed');
...
add_action('epl_property_category','epl_property_category');
